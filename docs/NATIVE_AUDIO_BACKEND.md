...
| --- | --- | --- | --- |
| Parity drift — native playback sounds different from bounces (which stay Web Audio) | 2 | High | Parity harness from phase 0: fixture renders diffed numerically per DSP port; spec-matched compressor; tolerance-tested resampler. Treat any audible diff as a release blocker. |
