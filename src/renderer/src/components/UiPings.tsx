...
/**
 * Middle-mouse pings for everything OUTSIDE the timeline grid (the grid
 ...
 *
 * One component does both halves: the global middle-click listener that
 * SENDS, and the fixed-position overlay that DRAWS anchored rings and
 * label-only notices.
 */
...
export function UiPings(): React.JSX.Element {
  ...
  useEffect(() => {
    const onMouseDown = (e: MouseEvent): void => {
      ...
      if (target?.closest?.('.timeline-grid')) return
